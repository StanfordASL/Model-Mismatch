...
[prog, obj, E, L_E] = define_C_3(r,rt,V_1,rho_1,dynamics.c,n_c,le_order,delta_E);
...
[prog,gamma,Ly,Ls,u,free_vars] = define_C_12_Plane(dynamics,r,rt,up,gp,gs,V_1,rho_1,u_order,ls_order,ly_order,lp_order);
