function [prog,gamma,Ly,Ls,u,coeffs] = define_C_12_Plane(dynamics,r,rt,up,gp,gs,V,rho,u_order,ls_order,ly_order,lp_order)
...
%Control constraints
%add in drag & gravity terms for acceleration
